...
const Projects = () => {
  ...
  return (
    <section className='c-space my-2o' id='Project'>
      ...
      <div className='grid lg:grid-cols-2 grid-cols-1 mt-12 gap-5 w-full'>
        <div className='flex flex-col gap-5 relative sm:p-10 py-10 px-5 shadow-2xl shadow-black-200'>
          ...
          <div className='p-3 backdrop-filter backdrop-blur-3xl rounded-xl style={myProjects[0].logoStyle}'>
            <img src={currProject.logo} alt="logo" className='w-20 h-20 object-contain' />
          </div>
          <div className='flex flex-col gap-5 txt-white-600 my-5'>
            <p className='text-white text-2xl font-semibold animatedText'>{currProject.title}</p>
            <p className='text-white animatedText'>{currProject.desc}</p>
            <p className='text-white animatedText'>{currProject.sub_desc}</p>
          </div>
          <div className='flex items-center justify-between flex-wrap gap-5'>
            <div className='flex items-center gap-3'>
              {currProject.tags.map(
                (tag,index)=>(
